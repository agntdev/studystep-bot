...
const HELP =
  "Choose a subject, send your question, then use the follow-up buttons for another explanation or practice.\n\n" +
  "Commands: /start, /help, /ask, and /summary. Teachers can also create a study summary from the menu.";
